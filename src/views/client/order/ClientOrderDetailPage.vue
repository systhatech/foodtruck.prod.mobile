                                ...
                                <v-col cols="12">
                                    <div class="custom-bs pa-4 mb-4">
                                        ...
                                        <div class="d-flex align-start" v-if="orderDetail.pickup_addr">
                                            ...
                                            <div>
                                                <p class="mb-0">{{ orderDetail.pickup_addr ? orderDetail.pickup_addr.add1
                                                    : '' }}</p>
                                                <p class="">
                                    ...
                                    <div class="order-item-wrapper pa-4  custom-bs">
                                        <div class="d-flex align-center justify-space-between">
                                            ...
                                            <v-chip class="text-capitalize" color="accent"
                                                small>{{ orderDetail.status }}</v-chip>
                                        </div>
                                        <div class="pb-2">
                                        ...
                                        <ul class="main-items mt-4">
                                            <li v-for="(item, index) in orderDetail.items" :key="index">
                                                <div>
                                                    <div class="d-flex">
                                                        <div class="mr-2">
                                                            <v-img :src="base_url + '/image-show/' + item.menu_item.profile_pic"
                                                                :lazy-src="`https://picsum.photos/10/6?image=15`"
                                                                class="grey lighten-2" max-height="70" max-width="80"
                                                                contain>
                                                        ...
                                                        <div class="item-description">
                                                            <div>
                                                                <h5 class="text-uppercase primary--text mb-0">{{
                                                                    item.menu_item.name }}</h5>
                                                                <p class="text-capitalize mb-1">Quatity : {{ item.quantity
                                                                }}</p>
                                                                <h4 class="primary--text">{{
                                                                    formatAmount(item.menu_item.price * item.quantity) }}
                                                                </h4>
                                                            </div>
                                                ...
                                                <v-col cols="12" md="6" lg="6" xl="6">
                                                    <table class="w-100">
                                                        ...
                                                        <tr v-if="Number(orderDetail.tips_amount)">
                                                            <td class="">Tip</td>
                                                            <td class="text-right">{{ formatAmount(orderDetail.tips_amount) }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="">
                                                                <h4 class="text-uppercase primary--text">Total</h4>
                                                            </td>
                                                            <td class=" text-right">
                                                                <h4 class="text-uppercase primary--text">
                                                    ...
                                                    <div class="text-right mt-4" v-if="orderDetail.payment">
                                                        <p v-if="orderDetail.payment.payment_type.toLowerCase() == 'cash'"
                                                            class="payment text-uppercase color-secondary f8-bold mb-0">Not
                                                            Paid</p>
                                                        <p v-else class="payment success--text f8-bold mb-0">PAID BY: <span
                                                                class="text-uppercase">{{ orderDetail.payment.payment_type }}</span>
                                                            ****{{ orderDetail.payment.cr_last4 }}</p>
                                                        <span class="f9">{{ formatDateTime(orderDetail.payment.created_at)
                                                        }}</span>
                                                    </div>
                                                </v-col>
                                            </v-row>
