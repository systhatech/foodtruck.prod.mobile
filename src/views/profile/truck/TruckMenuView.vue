<template>
    <v-container class="ma-0 pa-0 background-image h-100">
        ...
        <v-container class="mg56">
           <div class="background-white pa-4 mb-14" v-if="item && Object.keys(item).length">
                <div>
...
import DialogVarientAdd from './TruckMenuVarientAdd'
import DialogVarientUpdate from './TruckMenuVarientUpdate'
